...
**A rootful unit needs the image in root's store.** Pulling as your user does not help — see `34.md`.
...
| Port bind refused | A port below 1024 attempted rootless (`34.md`) |
