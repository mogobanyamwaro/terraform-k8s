...
kubectl describe pod api-5f8d7c -n prod > /opt/api-5f8d7c-describe.txt
kubectl logs api-5f8d7c -n prod --all-containers > /opt/api-5f8d7c-logs.txt
kubectl get pod api-5f8d7c -n prod -o yaml > /opt/api-5f8d7c.yaml
```
